...
**(Topic 3)**  -  Boolean Expressions and Conditional Constructs (If-Else)
...
**(Topic 8)**  -  Preparation for Midterm Exam 1

**(Topic 9)**  -  Multidimensional Arrays

**(Topic 10)**  -  Pointers and References
